...
final class Version20220830081016 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE creator_program (creator_id INT NOT NULL, program_id INT NOT NULL, INDEX IDX_1C7FCEF061220EA6 (creator_id), INDEX IDX_1C7FCEF03EB8070A (program_id), PRIMARY KEY(creator_id, program_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE creator_program ADD CONSTRAINT FK_1C7FCEF061220EA6 FOREIGN KEY (creator_id) REFERENCES creator (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE creator_program ADD CONSTRAINT FK_1C7FCEF03EB8070A FOREIGN KEY (program_id) REFERENCES program (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE creator_program DROP FOREIGN KEY FK_1C7FCEF061220EA6');
        $this->addSql('ALTER TABLE creator_program DROP FOREIGN KEY FK_1C7FCEF03EB8070A');
        ...
        $this->addSql('DROP TABLE creator_program');
