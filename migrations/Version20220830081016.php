 ...
 */
final class Version20220830081016 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE creator (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, poster VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE creator_series (creator_id INT NOT NULL, series_id INT NOT NULL, INDEX IDX_1C7FCEF061220EA6 (creator_id), INDEX IDX_1C7FCEF03EB8070A (series_id), PRIMARY KEY(creator_id, series_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE season (id INT AUTO_INCREMENT NOT NULL, series_id INT DEFAULT NULL, number INT DEFAULT NULL, year INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_F0E45BA93EB8070A (series_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE creator_series ADD CONSTRAINT FK_1C7FCEF061220EA6 FOREIGN KEY (creator_id) REFERENCES creator (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE creator_series ADD CONSTRAINT FK_1C7FCEF03EB8070A FOREIGN KEY (series_id) REFERENCES series (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE season ADD CONSTRAINT FK_F0E45BA93EB8070A FOREIGN KEY (series_id) REFERENCES series (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE actor_series DROP FOREIGN KEY FK_B01827EE3EB8070A');
        ...
        $this->addSql('ALTER TABLE creator_series DROP FOREIGN KEY FK_1C7FCEF061220EA6');
        $this->addSql('ALTER TABLE creator_series DROP FOREIGN KEY FK_1C7FCEF03EB8070A');
        ...
        $this->addSql('DROP TABLE creator_series');
